...
class ModelTrainerConfig:
    def __init__(self,training_pipelin_config : TrainingPipelineConfig):
        self.model_trainer_dir :str = os.path.join(training_pipelin_config.artifact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME)
